...
tags_metadata = [
    ...
    {
        "name": "postlogin",
        "description": "Operations with postlogin session management. Initialize and renew session tokens."
    },
    {
        "name": "mock",
        "description": "Mock API endpoints for testing external service integrations."
    }
]
servers_metadata = [
    {
